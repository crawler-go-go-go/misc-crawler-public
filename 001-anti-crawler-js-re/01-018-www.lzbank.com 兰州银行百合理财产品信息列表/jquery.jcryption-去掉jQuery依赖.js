...
function encryptUrl(url) {
    const encryData = "ber";
    const passwordKey = new jsSHA(encryData, "ASCII").getHash("SHA-512", "HEX");
    return $.jCryption.encrypt(url, passwordKey);
}


const url = "/cportalweb/public/lilyMangeMoney/getLilyMangeMoneyAllList.xhtml?fromUrl=https://www.lzbank.com/public/pbhlc.html&t=1606373206830";
console.log(encryptUrl(url));
